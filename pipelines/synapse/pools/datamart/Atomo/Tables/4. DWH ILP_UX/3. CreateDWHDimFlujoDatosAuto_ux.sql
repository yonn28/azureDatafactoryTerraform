...
-- Description: Se crea la STG.DIM_FLUJODATOSAUTO_UX la cual es un insumo para las vistas de los tableros de Atomo
-- =============================================

CREATE TABLE [ATOMO].[DWH.DIM_FLUJODATOSAUTO_UX]
(
