...
-- Description: Se crea la Fact DWH.FACT_DESEMPENO_INDICADOR_ILP la cual es un insumo para las vistas de los tableros de Atomo
...
CREATE TABLE [ATOMO].[DWH.FACT_DESEMPENO_INDICADOR_ILP]
(
