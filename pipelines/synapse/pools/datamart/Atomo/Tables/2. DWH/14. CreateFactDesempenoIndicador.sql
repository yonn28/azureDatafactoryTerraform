...
-- Description: Se crea la Fact DWH.FACT_DESEMPENO_INDICADOR la cual es un insumo para las vistas de los tableros de Atomo
-- =============================================

CREATE TABLE [ATOMO].[DWH.FACT_DESEMPENO_INDICADOR]
(
	...
	[RECONOCIMIENTO_CVR_MAX] [varchar](200) NULL,
	[RECONOCIMIENTO_CVR_MIN] [varchar](200) NULL,
	[COMENTARIO_CORTO] [varchar](200) NULL,
	[COMENTARIO_ACUMULADO] [varchar](400) NULL,
	[OBSERVACIONES] [varchar](200) NULL,
	[FECHA_CARGA_SYNAPSE]  [datetime] NULL,
	[FECHA_PROXIMA_ACTUALIZA_SYNAPSE]  [datetime] NULL
 CONSTRAINT [Th_Desempeno_Indicador_PK] UNIQUE NONCLUSTERED 
	(
		[FK_PARAM_INDICADOR] ASC
	) NOT ENFORCED 
)
WITH
(
