...
-- Description: Se crea la Fact DWH.FACT_ENTREGABLE_HITO la cual es un insumo para las vistas de los tableros de Atomo
-- =============================================

CREATE TABLE [ATOMO].[DWH.FACT_ENTREGABLE_HITO]
(
