...
-- Description: Se crea la Dimension DWH.DIM_ENTREGABLES_HITO la cual es un insumo para las vistas de los tableros de Atomo
-- =============================================

CREATE TABLE [ATOMO].[DWH.DIM_ENTREGABLES_HITO]
(
