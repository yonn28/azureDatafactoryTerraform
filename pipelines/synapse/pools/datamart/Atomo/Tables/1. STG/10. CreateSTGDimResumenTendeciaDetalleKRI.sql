...
-- Description: Se crea la Dimension STG.RESUMEN_TENDENCIA_DETALLE_KRI_TD la cual es un insumo para las cargas DWH
-- =============================================

CREATE TABLE [ATOMO].[STG.RESUMEN_TENDENCIA_DETALLE_KRI_TD]
(
