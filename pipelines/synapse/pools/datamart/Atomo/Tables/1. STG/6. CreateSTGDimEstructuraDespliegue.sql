...
-- Description: Se crea la Dimension STG.DIM_ESTRUCTURA_DESPLIEGUE la cual es un insumo para las cargas DWH
-- ============================================= 

CREATE TABLE [ATOMO].[STG.DIM_ESTRUCTURA_DESPLIEGUE]
(
